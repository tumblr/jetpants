module Jetpants
  ...
  class DB
    ...
    def clone_to!(*targets)
      ...
      [self, targets].flatten.concurrent_each {|t| t.disable_monitoring('NIC-Bandwidth-10G-BF2-Data'); t.stop_query_killer; t.stop_mysql}
      ...
      [self, targets].flatten.concurrent_each do |t|
        ...
        t.enable_monitoring('NIC-Bandwidth-10G-BF2-Data')
      end
