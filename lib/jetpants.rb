...
module Jetpants
  ...
  @config = {
    ...
    'ssh_port'                =>  false,      # port to use for remote SSH connections
    'ssh_user'                =>  'root',     # user for SSH connections
    ...
    'mysql_fast_restart'      =>  2000,      # Value to set for innodb_io_capacity for fast mysql restarts, used in DB#Prepare_fast_shutdown, called in DB#Restart_mysql
  }
