  ...
  module Plugin
    module JetCollins
      ...
      def collins_set(*args)
        ...
        asset = attrs[:asset] || collins.asset.call
        ...
        attrs.each do |key, val|
          ...
          when :status
            ...
            if state_val
              ...
              next unless previous_state != state_val.to_s.upcase || previous_status != val.to_s.capitalize
                success = collins.set(asset, val, state_val)
                unless success
                  asset.state_create!(state_val, state_val, state_val, val)
                  success = collins.set(asset, val, state_val)
                end
              ...
              success = collins.set(asset, val, false)
          ...
          when :state
            ...
            if previous_value != val
              success = collins.set(asset, key.to_s.upcase, val, true)
