...
module Jetpants
  class CommandSuite < Thor
    ...
    def merge_shards
      ...
      aggregate_node = Shard.set_up_aggregate_node(shards_to_merge, aggregate_node_ip)
      ...
      Shard.ship_aggregate_data_to_new_master(aggregate_node, new_shard_master, aggregate_shard)
